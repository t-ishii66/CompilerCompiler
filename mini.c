...
void _f1(int n, int a) {print("#include <stdio.h>\nint main(){\n");call(1);print("return 0;\n}\n");}
void _f2(int n, int a) {call(1);call(2);}
void _f3(int n, int a) {call(1);}
void _f4(int n, int a) {print("int ");call(1);print(";\n");}
void _f5(int n, int a) {call(1);print("=");call(2);print(";\n");}
void _f6(int n, int a) {print("scanf(\"%d\",&");call(1);print(");\n");}
void _f7(int n, int a) {print("printf(\"%d\\n\",");call(1);print(");\n");}
void _f8(int n, int a) {print("if(");call(1);print("){\n");call(2);print("}\n");}
void _f9(int n, int a) {print("while(");call(1);print("){\n");call(2);print("}\n");}
void _f10(int n, int a) {call(1);call(2);}
void _f11(int n, int a) {print("");}
void _f12(int n, int a) {call(1);print(">");call(2);}
void _f13(int n, int a) {call(1);print("<");call(2);}
void _f14(int n, int a) {call(1);print("==");call(2);}
void _f15(int n, int a) {call(1);print("+");call(2);}
void _f16(int n, int a) {call(1);print("-");call(2);}
void _f17(int n, int a) {call(1);print("*");call(2);}
void _f18(int n, int a) {call(1);print("/");call(2);}
void _f19(int n, int a) {call(1);}
void _f20(int n, int a) {call(1);}
void _f21(int n, int a) {call(1);}
